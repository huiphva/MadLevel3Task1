package io.huip.madlevel3task1
...
class RatingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnRatingFragment.setOnClickListener {
            navigateToSummary()
        }
    ...
    private fun showRandomAssessableGame() {
        ...
        tvRatingSubTitle.text = randomGame
    }

    private fun navigateToSummary() {
        val args = Bundle()
        args.putFloat(ARG_GAME_RATING, rbRatingFragment.rating)
        args.putString(ARG_GAME_NAME, tvRatingSubTitle.text.toString())
